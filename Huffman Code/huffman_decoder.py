...
with open('huffman_encode.txt', 'r', encoding='utf-8') as f:
    encoded_text = f.read()

# === Step 2: Read codebook ===
codebook = {}
with open('huffman_codebook.txt', 'r', encoding='utf-8') as f:
    for line in f:
...
with open('huffman_decode.txt', 'w', encoding='utf-8') as f:
